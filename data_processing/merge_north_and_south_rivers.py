...
df1 = pd.read_csv(data_dir+'NorthernSAF/all_tiles/NorthernSAF_profiles_SO3.csv')
df2 = pd.read_csv(data_dir+'SouthernSAF/all_tiles_merged/SouthernSAF_profiles_SO3.csv')
...
print(master_df)
master_df.to_csv(data_dir+'SAF_combined/all_data/'+'SAF_profiles_SO3.csv',index=False)
